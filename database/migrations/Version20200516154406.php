...
class Version20200516154406 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE customers (id INT AUTO_INCREMENT NOT NULL, organization_name VARCHAR(255) NULL, paypal_client_id VARCHAR(255) NULL, domain VARCHAR(255) NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, amount FLOAT NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP, charged TINYINT(1) DEFAULT 0, customer_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_GASAGA1241551256 FOREIGN KEY (customer_id) REFERENCES customers (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE orders DROP FOREIGN KEY FK_GASAGA1241551256');
