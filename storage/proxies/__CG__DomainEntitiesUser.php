...
class User extends \Domain\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'id', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'name', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'surname', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'username', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'email', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'password', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'isActive', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'customer', '' . "\0" . 'Domain\\Entities\\User' . "\0" . 'admin'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCustomer(\Domain\Entities\Customer $customer): void
    {
